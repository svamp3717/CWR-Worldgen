...
def patch_buildings() -> None:
    ...
    replacements = {
        "_foundation_texture_image(self.texture_size)": "modeler_foundation_texture_image(self.texture_size)",
        "_door_texture_image(\n                        self.texture_size,": "modeler_door_texture_image(\n                        self.texture_size,",
        "_wall_texture_image(\n                            family,": "modeler_wall_texture_image(\n                            family,",
        "_open_wall_texture_image(\n                            family,": "modeler_open_wall_texture_image(\n                            family,",
        "_interior_wall_texture_image(\n                            family,": "modeler_interior_wall_texture_image(\n                            family,",
        "_front_texture_image(\n                            family,": "modeler_front_texture_image(\n                            family,",
        "_roof_texture_image(\n                            roof, size=self.texture_size,": "modeler_roof_texture_image(\n                            roof, size=self.texture_size,",
    }
