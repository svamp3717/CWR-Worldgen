...
def test_generated_gravel_uses_dirt_family_for_connector_geometry_only():
    assert _junction._family_with_generated_gravel(r"synthetic\i\gravel3.p3d") == "ces"
    assert _junction._family_with_generated_gravel(r"synthetic\i\gravel6_l15.p3d") == "ces"
    assert _junction._family_with_generated_gravel(r"O\Road\sil25.p3d") == "sil"
