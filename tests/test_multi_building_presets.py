...
def test_mixed_stock_cache_wrapper_uses_current_stock_revision() -> None:
    ...
    assert stock_ext.STOCK_PLACEMENT_CACHE_NAMESPACE == stock_ext._STOCK_PLACEMENT_CACHE_V100
    assert stock_ext._STOCK_PLACEMENT_CACHE_V99 != stock_ext.STOCK_PLACEMENT_CACHE_NAMESPACE
