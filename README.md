...
A tool that generates playable Operation Flashpoint / Cold War Assault islands from real-world OpenStreetMap + elevation data, it also uses Overtune as fallback for missing buildings in OSM.
