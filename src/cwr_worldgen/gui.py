...
class WorldgenGui(tk.Tk):
    ...
    def _build_world_page(self) -> None:
        ...
        ttk.Checkbutton(
            world,
            text="Copy generated world PBO into an existing game mod folder",
        ...
        ttk.Label(
            world,
            text="Choosing a folder enables deployment automatically. The builder copies only the generated PBO into the existing Addons folder and does not create another @mod wrapper.",
            style="Hint.TLabel",
            wraplength=700,
    ...
    def _build_appearance_page(self) -> None:
        ...
        fields = (
            ...
            ("Interior undergrowth warning threshold", "forest_undergrowth_max_objects", "120000"),
            ("Interior undergrowth spacing (m)", "forest_undergrowth_spacing", "30"),
            ("Steep-hill bush warning threshold", "max_steep_hill_bush_objects", "80000"),
            ("Steep-hill bush spacing (m)", "steep_hill_bush_spacing", "24"),
            ("Steep-hill minimum slope (°)", "steep_hill_bush_min_slope", "16"),
            ("Wetland reed warning threshold", "max_wetland_reed_objects", "100000"),
            ("Wetland reed spacing (m)", "wetland_reed_spacing", "18"),
            ("Meadow grass warning threshold", "max_meadow_grass_objects", "20000"),
            ("Meadow grass spacing (m)", "meadow_grass_spacing", "24"),
            ("Hay bale warning threshold", "max_haybale_objects", "800"),
            ("Hay bale candidate spacing (m)", "haybale_spacing", "110"),
            ("Farmland fields with hay bales (%)", "haybale_field_percent", "25"),
            ("Extra single-tree warning threshold at 6.4 km", "max_forest_single_tree_objects", "1000"),
            ...
            ("Sidewalk object warning threshold", "max_sidewalk_objects", "30000"),
            ("Sidewalk nominal width / offset (m)", "sidewalk_width", "1.8"),
            ("Stock sidewalk tile spacing (m)", "sidewalk_segment_length", "5.0"),
            ("Street furniture warning threshold", "max_street_furniture_objects", "12000"),
            ...
            ("Building warning threshold", "max_buildings", str(DEFAULT_MAX_BUILDINGS)),
            ...
            ("Cemetery grave warning threshold", "max_grave_objects", "12000"),
            ...
            ("Infill-house warning threshold", "max_residential_infill_buildings", "1500"),
            ("Residential infill spacing (m)", "residential_infill_spacing", "68"),
            ("Residential infill min area (m²)", "residential_infill_min_area", "1800"),
            ("Forest object warning threshold", "max_forest_objects", str(DEFAULT_MAX_FOREST_OBJECTS)),
