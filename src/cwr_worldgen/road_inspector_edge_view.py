...
"""Add approximate road-strip edges to the Road Inspector HTML overview.

The numeric seam detector remains authoritative.  This view simply makes its
findings easier to inspect by drawing the two road edges around each emitted
center segment.  Straight P3Ds are exact in plan view; curve/junction arms are a
chord approximation for orientation context.
"""
